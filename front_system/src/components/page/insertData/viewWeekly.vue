        ...
        <div>
                ...
                <el-form :inline="true" :model="filters">
                    <el-col :span="6">
                        ...
                        <el-date-picker v-model="filters.filter_date" type="week" format="yyyy-WW 周"
                                        @change="dateChange1" placeholder="选择周" :picker-options="weekOption">
                        </el-date-picker>
                    </el-col>
            ...
            <table border="1" class="table table-responsive table-bordered" width="100%" v-show="weekly_dict">
                ...
                <tr v-for="item in weekly_dict">
                    ...
                    <td width="8%" :rowspan="item.span" :class="{hidden: item.dis}">{{item.total_time | num_round}}</td>
                    <td width="10%">{{item.description}}</td>
                    <td width="10%">{{item.duration_time | num_round}}</td>
